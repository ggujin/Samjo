...
<section class="page-section">
    <div class="container">
        <div class="product-item push_down">
            <div class="product-item-title d-flex">
                <div class="bg-faded p-5 d-flex ms-auto rounded">
                    <h2 class="section-heading mb-0">
                        <span class="section-heading-upper">We Can Control SVG</span>
                        <span class="section-heading-lower">UpSizing Dot</span>
                    </h2>
                </div>
            </div>
            <div class="mysvgcontainer">
                <svg class="mysvg">
                    <circle class="dot"></circle>
                </svg>
            </div>
            <div class="product-item-description d-flex me-auto">
                <div class="bg-faded p-5 rounded"><p class="mb-0">This is amazing dot.<br> i think, you'll like it. click the dot.
                and take relax by click. you can imagine your future, and have a sweet dream.</p></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="product-item">
            <div class="product-item-title d-flex">
                <div class="bg-faded p-5 d-flex me-auto rounded">
                    <h2 class="section-heading mb-0">
                        <span class="section-heading-upper">polymorphism</span>
                        <span class="section-heading-lower">Square to Circle</span>
                    </h2>
                </div>
            </div>
            <div class="mydiv">
                <svg class = rectanglecontainer>
                    <rect class = myrectangle></rect>
                </svg>
            </div>
            <div class="product-item-description d-flex ms-auto">
                <div class="bg-faded p-5 rounded"><p class="mb-0"><strong>Hey take a deep breath</strong>, and move your mouse left to right.
                our life has polymorphism, there are no unchanging stuff.</p></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="product-item">
            <div class="product-item-title d-flex">
                <div class="bg-faded p-5 d-flex ms-auto rounded">
                    <h2 class="section-heading mb-0">
                        <span class="section-heading-upper">Cute of Scary</span>
                        <span class="section-heading-lower">ZomZom</span>
                    </h2>
                </div>
            </div>

            </div>
        <div class="mymysvgcontainer">
            <div class="myrealcontainer">
                <svg class="zomzom" xmlns="http://www.w3.org/2000/svg"
...
<path style="fill:#FF738D;" d="M434.661,164.828c-0.932-5.368-2.086-10.696-3.497-15.956C409.953,69.843,337.923,14.649,256,14.649
	...
	<path style="opacity:0.3;fill:#20272E;enable-background:new    ;" d="M455.499,270.399h-4.185v-74.388
		...
		c16.632,2.974,29.297,17.546,29.297,35.021C491.074,333.912,478.409,348.484,461.777,351.458z"/>
            ...
            <div class="product-item-description d-flex me-auto">
                <div class="bg-faded p-5 rounded"><p class="mb-0"> what a cute zombie. He's name is zomzom. but
                it doesn't apply to everyone. Don't force your taste. if you think it's cute, love it.</p></div>
            </div>
        </div>
    </div>
</section>
