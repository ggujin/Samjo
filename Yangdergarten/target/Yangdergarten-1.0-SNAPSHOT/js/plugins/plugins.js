        ...
        b = function(e, p) {
                    ...
                    function(r) {
                        ...
                        return (
                            ...
                            (r.wheelDeltaX && (i.deltaX = -0.025 * r.wheelDeltaX),
                                r.wheelDeltaY && (i.deltaY = -0.025 * r.wheelDeltaY), !i.deltaY && !i.deltaX && (i.deltaY = -0.025 * r.wheelDelta)) :
                            (i.deltaY = r.detail),
                            t.call(e, i)
                        );
                    },
            ...
            (this.init = function() {
                ...
                if (
                    ((P.isie11 || P.isie10) && (e["-ms-overflow-style"] = "none"),
                        ...
                        (T.zindex = M.zindex) :
                        (T.zindex = b() || "auto"), !T.ispage && "auto" != T.zindex && T.zindex > s && (s = T.zindex),
                        T.isie &&
                        0 === T.zindex &&
                        "auto" == M.zindex &&
                                ...
                                if (
                                    (T.railh &&
                                        ...
                                        ((u = T.isrtlmode ?
                                            ...
                                            (u < 0 && ((u = 0), (a = 0)),
                                                u > T.page.maxw && ((u = T.page.maxw), (a = 0)))), !T.hasmoving)
                                ) {
                                    if (
                        ...
                        (P.hasw3ctouch ?
                            ...
                            (T.bind(
                                ...
                                (T.bind(T.cursorh, "mousedown", function(e) {
                                    ...
                                    T.bind(T.cursorh, "mouseup", T.onmouseup)), !T.ispage &&
            ...
            (this.remove = function() {
                ...
                T.doZoomOut(),
                    T.unbindAll(),
                    P.isie9 &&
                    T.win[0].detachEvent("onpropertychange", T.onAttributeChange), !1 !== T.observer && T.observer.disconnect(), !1 !== T.observerremover && T.observerremover.disconnect(), !1 !== T.observerbody && T.observerbody.disconnect(),
                    (T.events = null),
